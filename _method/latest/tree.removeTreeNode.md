...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.removeTreeNode('CompName', 'nodeId');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="removeTreeNode" onclick="SBUxMethod.removeTreeNode('sbTagNm1');">
...
{% highlight html %}
<input type="button" value="removeTreeNode" onclick="SBUxMethod.removeTreeNode('sbTagNm2');">
