...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">지정된 level의 node들을 반환 합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.getTreeSblingData('CompName', 'rootNodeId', 'level', 'filteringKey');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="getTreeSblingData" onclick="alert(SBUxMethod.getTreeSblingData('sbTagNm1', '1', '1'));">
...
{% highlight html %}
<input type="button" value="getTreeSblingData" onclick="alert(SBUxMethod.getTreeSblingData('sbTagNm2', '1', '1'));">
