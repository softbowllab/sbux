...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 title을 변경합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.setModalTitle('CompName', 'changeTitle');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="setModalTitle" onclick="SBUxMethod.setModalTitle('sbTagNm1', '변경할 Modal 타이틀');">
...
{% highlight html %}
<input type="button" value="setModalTitle" onclick="SBUxMethod.setModalTitle('sbTagNm2', '변경할 Modal 타이틀');">
...
{% highlight html %}
<input type="button" value="setModalTitle" onclick="SBUxMethod.setModalTitle('sbTagNm3', '변경할 Modal 타이틀');">
