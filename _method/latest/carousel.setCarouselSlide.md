...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">지정한 slide로 이동합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.setCarouselSlide('CompName', 'slideNum');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="setCarouselSlide" onclick="SBUxMethod.setCarouselSlide('sbTagNm1', 2);">
...
{% highlight html %}
<input type="button" value="setCarouselSlide" onclick="SBUxMethod.setCarouselSlide('sbTagNm2', 2);">
