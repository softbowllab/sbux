...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 tab을 삭제합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.removeTab('CompName', 'tabId');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="removeTab" onclick="SBUxMethod.removeTab('sbTagNm1', 'tab1_2');">
...
{% highlight html %}
<input type="button" value="removeTab" onclick="SBUxMethod.removeTab('sbTagNm2', 'tab2_2');">
...
{% highlight html %}
<input type="button" value="removeTab" onclick="SBUxMethod.removeTab('sbTagNm3', 'tab3_2');">
