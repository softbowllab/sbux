...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.getTabsCount('CompName');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="getTabsCount" onclick="alert(SBUxMethod.getTabsCount('sbTagNm1'));">
...
{% highlight html %}
<input type="button" value="getTabsCount" onclick="alert(SBUxMethod.getTabsCount('sbTagNm2'));">
...
{% highlight html %}
<input type="button" value="getTabsCount" onclick="alert(SBUxMethod.getTabsCount('sbTagNm3'));">
