...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">선택된 node의 상태값을 반환합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.getTreeStatus('CompName', 'nodeId');</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="tdCenter">string</td>
        <td>status를 확인할 node Id</td>
        <td>- 생략 가능 (생략시 선택한 nodeId)</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<input type="button" value="getTreeStatus" onclick="alert(JSON.stringify(SBUxMethod.getTreeStatus('sbTagNm1')));">
...
{% highlight html %}
<input type="button" value="getTreeStatus" onclick="alert(JSON.stringify(SBUxMethod.getTreeStatus('sbTagNm2')));">
