...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.refresh('CompName', data);</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="tdCenter">string | 변수명</td>
        <td>재호출시 변경할 modal data</td>
        <td>
            - 생략 가능<br>
        </td>
    </tr>
...
<script>
    var refreshData='<body-html>추가된 modal body</body-html>';
</script>
...
<input type="button" value="refresh" onclick="SBUxMethod.refresh('sbTagNm1', refreshData);">
...
<input type="button" value="refresh" onclick="SBUxMethod.refresh('sbTagNm2', refreshData);">
...
<input type="button" value="refresh" onclick="SBUxMethod.refresh('sbTagNm3', refreshData);">
