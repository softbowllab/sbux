...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.hideTab('TabId');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="hideTab" onclick="SBUxMethod.hideTab('tab1_2');">
...
{% highlight html %}
<input type="button" value="hideTab" onclick="SBUxMethod.hideTab('tab2_2');">
...
{% highlight html %}
<input type="button" value="hideTab" onclick="SBUxMethod.hideTab('tab3_2');">
