...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 항목을 비활성화합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.disableSideMenu('CompName', 'value', 'baseKey');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="disableSideMenu" onclick="SBUxMethod.disableSideMenu('sbTagNm1','1');">
