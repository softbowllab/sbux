...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 tab을 비활성화 합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.disableTab('TabId');</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="disableTab" onclick="SBUxMethod.disableTab('tab1_2');">
...
{% highlight html %}
<input type="button" value="disableTab" onclick="SBUxMethod.disableTab('tab2_2');">
...
{% highlight html %}
<input type="button" value="disableTab" onclick="SBUxMethod.disableTab('tab3_2');">
