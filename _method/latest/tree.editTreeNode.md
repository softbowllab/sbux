...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">node의 값을 변경합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">SBUxMethod.editTreeNode('CompName', 'nodeId', changeData);</td>
    </tr>
    <tr>
...
{% highlight html %}
<input type="button" value="editTreeNode" onclick="SBUxMethod.editTreeNode('sbTagNm1', '', {text : 'text 변경'});">
...
{% highlight html %}
<input type="button" value="editTreeNode" onclick="SBUxMethod.editTreeNode('sbTagNm2', '', {text : 'text 변경'});">
