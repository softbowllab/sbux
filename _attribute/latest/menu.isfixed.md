...
{% highlight html %}
<sbux-menu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" placement="bottom">
...
<sbux-menu id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="jsonData" is-fixed="false" placement="bottom">
   <brand-item text="SoftBowl"></brand-item>
</sbux-menu>
{% endhighlight %}
