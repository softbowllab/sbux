...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">전체적으로 지정할 title 문구를 설정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        <td class="tdTitle tdBg tdCenter">값형태</td>
...
<sbux-alert id="sbIdx1_1" name="sbTagNm1_1" uitype="alert" switch-name="test_1" case-array="{iValue,,input을 선택하셨습니다.,}^{pValue,,picker를 선택하셨습니다.,}^{rValue,,radio를 선택하셨습니다.,}^{sValue,,select를 선택하셨습니다.,}" base-title="공통 title"></sbux-alert>
{% endhighlight %}
