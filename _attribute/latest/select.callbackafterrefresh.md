...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component를 refresh 한 후에 호출되는 function을 지정합니다.</td>
    </tr>
    <tr>
...
<sbux-select id="sbIdx1_1" name="sbTagNm1_1" uitype="single" callback-after-refresh="afterRefreshfunc">
...
<sbux-select id="sbIdx1_2" name="sbTagNm1_2" uitype="single" jsondata-ref="jsondata" callback-after-refresh="afterRefreshfunc"></sbux-select>
...
<sbux-select id="sbIdx1_3" name="sbTagNm1_3" uitype="checkbox" jsondata-ref="jsondata" callback-after-refresh="afterRefreshfunc"></sbux-select>
