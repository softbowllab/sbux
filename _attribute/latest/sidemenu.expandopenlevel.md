...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">지정된 level의 menu를 확장합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">확장할 menu level</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<sbux-sidemenu id="sbIdx1_1" name="sbIdx1_1" uitype="normal" is-expand="true" expand-open-level="1">
...
<sbux-sidemenu id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="sideJsonData" is-expand="true" expand-open-level="1"></sbux-sidemenu>
{% endhighlight %}
