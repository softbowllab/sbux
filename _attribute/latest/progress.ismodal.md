...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">layerpopup의 뒷 배경을 선택하지 못하도록 설정합니다.</td>
    </tr>
    <tr>
...
<sbux-progress id="sbIdx1_1" name="sbTagNm1_1" uitype="bar" indicator-type="load" show-openlayer="true" is-modal="false">
    <progress-bar>
       <bar valuenow="0"></bar>
    </progress-bar>
</sbux-progress>
