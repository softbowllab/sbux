...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">menu 숨김버튼 표시 여부를 설정합니다.</td>
    </tr>
    <tr>
...
<sbux-sidemenu id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="sideJsonData" show-slide-button="true"></sbux-sidemenu>
{% endhighlight %}
