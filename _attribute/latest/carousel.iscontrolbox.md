...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">controller, indicator의 위치를 contolbox로 이동합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-carousel id="sbIdx1_1" name="sbIdx1_1" uitype="image" is-controlbox="true">
...
<sbux-carousel id="sbIdx1_2" name="sbTagNm1_2" uitype="image" jsondata-ref="carouselJsonData" is-controlbox="true"></sbux-carousel>
{% endhighlight %}
...
{% highlight html %}
<sbux-carousel id="sbIdx1_3" name="sbTagNm1_3" uitype="tag" is-controlbox="false">
