...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">현재 슬라이드 위치를 표시하는 indicator 표시 여부를 설정합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-carousel id="sbIdx1_1" name="sbIdx1_1" uitype="image" is-indicator="true">
...
<sbux-carousel id="sbIdx1_2" name="sbTagNm1_2" uitype="image" jsondata-ref="carouselJsonData" is-indicator="true"></sbux-carousel>
{% endhighlight %}
...
{% highlight html %}
<sbux-carousel id="sbIdx1_3" name="sbTagNm1_3" uitype="tag" is-indicator="true">
