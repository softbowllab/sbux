...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">menu의 확장 방식을 지정합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-sidemenu id="sbIdx1_1" name="sbIdx1_1" uitype="normal" expand-type="icon">
...
<sbux-sidemenu id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="sideJsonData" expand-type="icon"></sbux-sidemenu>
{% endhighlight %}
