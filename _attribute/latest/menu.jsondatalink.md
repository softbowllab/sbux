...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            호출한 json data에서 link에 해당하는 key값<br>
...
<script>
    var jsonData = [                
        ...
        { "id" : "1_1", "pid" : "1", "order" : "1", "text" : "input" , "linkKey" : "https://softbowllab.github.io/sbux/attribute/latest/input.uitype#input"},
...
<sbux-menu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="jsonData" jsondata-link="linkKey" is-fixed="false">
