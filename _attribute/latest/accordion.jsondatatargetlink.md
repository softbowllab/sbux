...
<script>
    var accJsonData=[
        { "id": "0", "pid": "-1", "order": "1", "targetid": "acc1_1", "text": "acc1_1", "targetlinkKey":"https://softbowllab.github.io/sbux/attribute/latest/input.uitype#input", "targetname":"targetIframe" },
        { "id": "1", "pid": "-1", "order": "2", "targetid": "acc1_2", "text": "acc1_2" }
    ];
</script>
<sbux-accordion id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="accJsonData" jsondata-target-link="targetlinkKey"></sbux-accordion>
<div id="acc1_1">
...
<script>
    var accJsonData2=[
        { "id": "0", "pid": "-1", "order": "1", "targetid": "acc2_1", "text": "acc2_1","targetlinkKey":"https://softbowllab.github.io/sbux/attribute/latest/input.uitype#input", "targetname":"targetIframe2" },
    ...
    $(document).ready(function(){
        $('#sbArea2_1').sbAccordion({
            ...
            jsondataTargetLink : 'targetlinkKey'
        });
    }); 
</script>
{% endhighlight %}
