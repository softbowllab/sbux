---
title:  title-target-id-array
date:   2018-05-14
categories: ["latest","tabs"]
order: 1
---

title-target-id-array
===
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 content id를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">{id1_1,id1_2}^id2^id3 (id와 id를 '^'로 구분, 드롭다운 형태는 '{','}'로 구분)</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
