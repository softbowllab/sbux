...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component에 마우스 hover했을때 나타나는 image의 주소를 지정합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-button id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" hover-image-src="./../img/loading.gif"></sbux-button>
{% endhighlight %}
...
{% highlight html %}
<sbux-button id="sbIdx1_2" name="sbTagNm1_2" uitype="modal" hover-image-src="./../img/loading.gif"></sbux-button>
{% endhighlight %}
...
{% highlight html %}
<sbux-button id="sbIdx1_3" name="sbTagNm1_3" uitype="submit" hover-image-src="./../img/loading.gif"></sbux-button>
{% endhighlight %}
...
{% highlight html %}
<sbux-button id="sbIdx1_4" name="sbTagNm1_4" uitype="send" hover-image-src="./../img/loading.gif"></sbux-button>
{% endhighlight %}
