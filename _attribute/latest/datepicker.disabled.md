...
{% highlight html %}
<sbux-datepicker id="sbIdx1" name="sbTagNm1" uitype="inline" disabled="disabled"></sbux-datepicker>
{% endhighlight %}
...
{% highlight html %}
<sbux-datepicker id="sbIdx2" name="sbTagNm2" uitype="popup" disabled="disabled"></sbux-datepicker>
{% endhighlight %}
