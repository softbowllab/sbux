---
title:  is-select-all-option
date:   2018-05-14
categories: ["latest","select"]
order: 12
---

is-select-all-option
===
...
<sbux-select id="sbIdx1_1" name="sbTagNm1_1" uitype="checkbox" jsondata-ref="jsondata" is-select-all-option="true"></sbux-select>
{% endhighlight %}
