---
title:  callback-slide-button
date:   2018-05-14
categories: ["latest","sidemenu"]
order: 26
---

callback-slide-button
===
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">slide button을 눌렀을때 호출되는 function을 지정합니다.</td>
    </tr>
    <tr>
   ...
   function slideButtonFunc(){
    ...
    $(document).ready(function(){
        $('#sbArea2_1').sbSidemenu({
            ...
            callbackSlideButton : 'slideButtonFunc'
        });
    }); 
</script>
{% endhighlight %}
