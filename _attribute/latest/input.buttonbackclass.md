...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component 입력란 뒤에 붙는 버튼의 class를 지정합니다.</td>
    </tr>
    <tr>
...
<sbux-input id="sbIdx" name="sbTagNm" uitype="search" button-back-text="검색" button-back-class="customClass"></sbux-input>
{% endhighlight %}
