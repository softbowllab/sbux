...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">node 데이터가 없을때 표시할 문구를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td>No tree data founded.</td>
        <td class="tdTitle">자료형</td>
        <td>string</td>
    </tr>
    <tr>
        <td class="tdTitle">값형태</td>
        <td colspan="3">empty message로 지정할 문구</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<sbux-tree id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="treeJsonData" empty-message="데이터가 없습니다."></sbux-tree>
{% endhighlight %}
...
<sbux-tree id="sbIdx1_2" name="sbTagNm1_2" uitype="checkbox" jsondata-ref="treeJsonData" empty-message="데이터가 없습니다."></sbux-tree>
{% endhighlight %}
