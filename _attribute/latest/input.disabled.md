...
{% highlight html %}
<sbux-input id="sbIdx1" name="sbTagNm1" uitype="text" disabled="disabled"></sbux-input>
{% endhighlight %}
...
{% highlight html %}
<sbux-input id="sbIdx2" name="sbTagNm2" uitype="password" disabled="disabled"></sbux-input>
{% endhighlight %}
...
{% highlight html %}
<sbux-input id="sbIdx3" name="sbTagNm3" uitype="search" disabled="disabled"></sbux-input>
{% endhighlight %}
