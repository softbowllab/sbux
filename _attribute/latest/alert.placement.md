...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component가 표시되는 위치를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">top-right | top-left | top-center | middle-right | middle-left | middle-center | bottom-right | bottom-left | bottom-center</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<sbux-alert id="sbIdx1_1" name="sbTagNm1_1" uitype="alert" switch-name="test_1" case-array="{iValue,,input을 선택하셨습니다.,}^{pValue,,picker를 선택하셨습니다.,}^{rValue,,radio를 선택하셨습니다.,}^{sValue,,select를 선택하셨습니다.,}" placement="bottom-left"></sbux-alert>
{% endhighlight %}
