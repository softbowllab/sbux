...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component가 지속되는 시간을 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component가 지속되게 할 시간(밀리세컨드)</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<sbux-alert id="sbIdx1_1" name="sbTagNm1_1" uitype="alert" switch-name="test_1" case-array="{iValue,,input을 선택하셨습니다.,}^{pValue,,picker를 선택하셨습니다.,}^{rValue,,radio를 선택하셨습니다.,}^{sValue,,select를 선택하셨습니다.,}" time="1000"></sbux-alert>
{% endhighlight %}
