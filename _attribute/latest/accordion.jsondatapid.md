...
<script>
    var accJsonData=[
        { "id": "0", "pidKey": "-1", "order": "1", "targetid": "acc1_1", "text": "acc1_1" },
        { "id": "1", "pidKey": "-1", "order": "2", "targetid": "acc1_2", "text": "acc1_2" }
    ];
</script>
<sbux-accordion id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="accJsonData" jsondata-pid="pidKey"></sbux-accordion>
<div id="acc1_1">
   acc contents 1
</div>
<div id="acc1_2">
...
<script>
    var accJsonData2=[
        { "id": "0", "pidKey": "-1", "order": "1", "targetid": "acc2_1", "text": "acc2_1" },
        { "id": "1", "pidKey": "-1", "order": "2", "targetid": "acc2_2", "text": "acc2_2" }
    ];
