...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">슬라이드가 자동으로 넘어가게 설정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">stream | reverse | none</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<sbux-carousel id="sbIdx1_1" name="sbIdx1_1" uitype="image" circulation="true" auto-stream="stream">
...
<sbux-carousel id="sbIdx1_2" name="sbTagNm1_2" uitype="image" jsondata-ref="carouselJsonData" circulation="true" auto-stream="stream"></sbux-carousel>
{% endhighlight %}
...
{% highlight html %}
<sbux-carousel id="sbIdx1_3" name="sbTagNm1_3" uitype="tag" circulation="true" auto-stream="stream">
