...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 초기상태가 확장형태로 설정합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-tree id="sbIdx1_1" name="sbIdx1_1" uitype="normal" is-expand="true">
    <tree-item text="1">
        <tree-item text="1_1">
...
<sbux-tree id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="treeJsonData" is-expand="true"></sbux-tree>
{% endhighlight %}
...
{% highlight html %}
<sbux-tree id="sbIdx1_3" name="sbIdx1_3" uitype="checkbox" is-expand="true">
    <tree-item text="1">
        <tree-item text="1_1">
            <tree-item text="1_1_1"></tree-item>
        </tree-item>
...
<sbux-tree id="sbIdx1_4" name="sbTagNm1_4" uitype="checkbox" jsondata-ref="treeJsonData" is-expand="true"></sbux-tree>
{% endhighlight %}
