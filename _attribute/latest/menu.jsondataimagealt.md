...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            호출한 json data에서 image alt에 해당하는 key값<br>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">호출한 json data에서 image alt에 해당하는 key값</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    var jsonData = [                
        ...
        { "id" : "3", "pid" : "-1", "order" : "3", "text" : "SBGrid", "imagesrc" : "./../img/SBGridLogo.png", "imagealtKey" : "SBGrid"},
...
<sbux-menu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="jsonData" jsondata-image-alt="imagealtKey" is-fixed="false">
