---
title:  jsondata-image-position
date:   2018-05-14
categories: ["latest","sidemenu"]
order: 23
---

jsondata-image-position
===
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            호출한 json data에서 image position에 해당하는 key값을 지정합니다.<br>
...
<script>
    var sideJsonData = [
        ...
        {"id": "2", "pid":"0",       "order":"2",  "text":"2", "imagesrc":"./../img/SBUxLogo.png", "imagepositionKey":"right"},
...
<sbux-sidemenu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="sideJsonData" jsondata-image-position="imagepositionKey"></sbux-sidemenu>
{% endhighlight %}
...
<script>
    ...
    $(document).ready(function(){
        $('#sbArea2_1').sbSidemenu({
            ...
            jsondataImagePosition : 'imagepositionKey'
        });
    }); 
</script>
{% endhighlight %}
