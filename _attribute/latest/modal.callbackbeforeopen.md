...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component가 나타나기 전 호출 할 함수를 지정합니다.</td>
    </tr>
    <tr>
...
<sbux-modal id="sbIdx1_1" name="sbTagNm1_1" uitype="small" callback-before-open="beforeOpenFunc"></sbux-modal>
...
<sbux-modal id="sbIdx1_2" name="sbTagNm1_2" uitype="middle" callback-before-open="beforeOpenFunc"></sbux-modal>
...
<sbux-modal id="sbIdx1_3" name="sbTagNm1_3" uitype="large" callback-before-open="beforeOpenFunc"></sbux-modal>
...
<script>
    ...
    $(document).ready(function(){
        $('#sbArea2_1').sbModal({
            name : 'sbScriptNm2_1',
            uitype : 'small',
            callbackBeforeOpen : 'beforeOpenFunc'
        });
    }); 
</script>
{% endhighlight %}
