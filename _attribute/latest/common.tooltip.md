...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component에 표시될 Tooltip의 문구를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">tooltip에 나타낼 문구</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<sbux-input id="sbIdx" name="sbTagNm" uitype="text" tooltip="SBUx Tooltip"></sbux-input>
{% endhighlight %}
