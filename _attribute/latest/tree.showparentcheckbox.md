...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">부모 node에도 checkbox를 표시합니다.</td>
    </tr>
    <tr>
...
<sbux-tabs id="exTab1" name="exTab1" uitype="normal" title-target-id-array="{exTab1_1,exTab1_2}" title-text-array="checkbox{고정형,변동형}" is-scrollable="false">
</sbux-tabs>
...
{% highlight html %}
<sbux-tree id="sbIdx1_1" name="sbIdx1_1" uitype="checkbox" show-parent-checkbox="true">
    <tree-item text="1">
        <tree-item text="1_1">
...
<sbux-tree id="sbIdx1_2" name="sbTagNm1_2" uitype="checkbox" jsondata-ref="treeJsonData" show-parent-checkbox="true"></sbux-tree>
{% endhighlight %}
