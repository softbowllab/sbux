---
title:  title-select-max-count
date:   2018-05-14
categories: ["latest","select"]
order: 9
---

title-select-max-count
===
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            항목 선택시 선택박스에 나타날 선택값의 개수를 제한합니다.<br>
...
<sbux-select id="sbIdx1_1" name="sbTagNm1_1" uitype="checkbox" jsondata-ref="jsondata" title-select-max-count="2"></sbux-select>
{% endhighlight %}
