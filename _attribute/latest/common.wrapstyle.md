...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 최상단 root에 CSS를 지정합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-input id="sbIdx" name="sbTagNm" uitype="text" wrap-style="font-weight:bold;"></sbux-input>
{% endhighlight %}
