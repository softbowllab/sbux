...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component에 표시되는 값을 valuemax 기준 백분율 값으로 표시합니다.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>indicator-type="stacked", valuemax</td>
...
{% highlight html %}
<sbux-progress id="sbIdx1_1" name="sbTagNm1_1" uitype="bar" unit="percent" indicator-type="stacked" valuemax="50">
    <progress-bar>
       <bar valuenow="40"></bar>
    </progress-bar>
</sbux-progress>
