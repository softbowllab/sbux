...
<table style="width:100%">
    ...
    <tr>
        ...
        <td>jsondata-ref, jsondata-image-src</td>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">호출한 json data에서 image style에 해당하는 key값</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    var treeJsonData=[
        { "id":"1",     "pid":"-1",  "order" : "1", "text" : "1", "imagesrc":"./../img/SBUxLogo.png", "imagestyleKey":"width:50px" },
...
<sbux-tree id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="treeJsonData" jsondata-image-src="imagesrc" jsondata-image-style="imagestyleKey"></sbux-tree>
{% endhighlight %}
...
<sbux-tree id="sbIdx1_2" name="sbTagNm1_2" uitype="checkbox" jsondata-ref="treeJsonData" jsondata-image-src="imagesrc" jsondata-image-style="imagestyleKey"></sbux-tree>
{% endhighlight %}
