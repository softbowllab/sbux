...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 footer content를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">footer content로 지정할 문구 및 tag</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<sbux-modal id="sbIdx1_1" name="sbTagNm1_1" uitype="small" footer-html="<b>Modal Footer</b>"></sbux-modal>
...
{% highlight html %}
<sbux-modal id="sbIdx1_2" name="sbTagNm1_2" uitype="middle" footer-html="<b>Modal Footer</b>"></sbux-modal>
...
{% highlight html %}
<sbux-modal id="sbIdx1_3" name="sbTagNm1_3" uitype="large" footer-html="<b>Modal Footer</b>"></sbux-modal>
