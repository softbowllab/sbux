...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">호출한 json data에 image title에 해당하는 key값</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    var carouselJsonData=[
        {imagesrc:'./../img/image1.jpg', imagetitleKey:'image1'},
        {imagesrc:'./../img/image2.jpg', imagetitleKey:'image2'},
        {imagesrc:'./../img/image3.jpg', imagetitleKey:'image3'}
    ];
</script>
...
<sbux-carousel id="sbIdx1_1" name="sbTagNm1_1" uitype="image" jsondata-ref="carouselJsonData" jsondata-image-title="imagetitleKey"></sbux-carousel>
{% endhighlight %}
