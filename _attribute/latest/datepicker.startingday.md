...
{% highlight html %}
<sbux-datepicker id="sbIdx1" name="sbTagNm1" uitype="inline" starting-day="3"></sbux-datepicker>
{% endhighlight %}
...
{% highlight html %}
<sbux-datepicker id="sbIdx2" name="sbTagNm2" uitype="popup" starting-day="3"></sbux-datepicker>
{% endhighlight %}
