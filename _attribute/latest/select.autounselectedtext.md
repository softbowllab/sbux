---
title:  auto-unselected-text
date:   2018-05-14
categories: ["latest","select"]
order: 2
---

auto-unselected-text
===
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">값이 없는 기본선택 항목을 자동으로 생성합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-select id="sbIdx1_1" name="sbTagNm1_1" uitype="single" auto-unselected-text="true">
...
<sbux-select id="sbIdx1_2" name="sbTagNm1_2" uitype="single" jsondata-ref="jsondata" auto-unselected-text="true"></sbux-select>
{% endhighlight %}
...
<sbux-select id="sbIdx1_3" name="sbTagNm1_3" uitype="checkbox" jsondata-ref="jsondata" auto-unselected-text="true"></sbux-select>
{% endhighlight %}
