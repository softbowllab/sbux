...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 footer button 위치를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">left | center | right</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<sbux-modal id="sbIdx1_1" name="sbTagNm1_1" uitype="small" footer-button-placement="left"></sbux-modal>
...
{% highlight html %}
<sbux-modal id="sbIdx1_2" name="sbTagNm1_2" uitype="middle" footer-button-placement="left"></sbux-modal>
...
{% highlight html %}
<sbux-modal id="sbIdx1_3" name="sbTagNm1_3" uitype="large" footer-button-placement="left"></sbux-modal>
