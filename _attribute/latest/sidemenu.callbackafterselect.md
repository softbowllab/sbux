...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">메뉴가 선택되기후에 호출되는 function을 지정합니다.</td>
    </tr>
    <tr>
...
<sbux-sidemenu id="sbIdx1_1" name="sbIdx1_1" uitype="normal" callback-after-select="afterSelectFunc">
...
<sbux-sidemenu id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="sideJsonData" callback-after-select="afterSelectFunc"></sbux-sidemenu>
{% endhighlight %}
