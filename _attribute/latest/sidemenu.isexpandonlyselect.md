...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">선택된 menu만 확장합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-sidemenu id="sbIdx1_1" name="sbIdx1_1" uitype="normal" is-expand-only-select="true">
...
<sbux-sidemenu id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="sideJsonData" is-expand-only-select="true"></sbux-sidemenu>
{% endhighlight %}
