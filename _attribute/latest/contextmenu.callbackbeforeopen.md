...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            menu가 표시되기 전 호출되는 function을 지정합니다.<br>
            (sbux-tree 에서만 사용가능합니다.)
        </td>
    </tr>
    <tr>
...
<script>
    function contextmenuCallbackFunc(){
        alert("menu open before callback");
    }
</script>
...
<sbux-contextmenu id="sbcontenxt1" name="sbcontenxt1" callback-before-open="contextmenuCallbackFunc">
