...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            모든 항목이 선택되었을시 표시될 문구를 지정합니다.<br>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">모든 항목이 선택되었을시 표시될 문구</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<sbux-select id="sbIdx1_1" name="sbTagNm1_1" uitype="checkbox" jsondata-ref="jsondata" title-select-all-text="All"></sbux-select>
{% endhighlight %}
