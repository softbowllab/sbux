...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component와 연결된 grid의 데이터를 변경하였을때 event 발생 여부를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">valuechanged | undefined</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    ...
    function createGrid(){
        ...
        datagrid.bind('valuechanged', 'gridEvent');
    };
...
<sbux-input id="sbIdx" name="name" uitype="text" grid-id="datagrid" grid-event="valuechanged"></sbux-input>
{% endhighlight %}
