...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 전체 menu가 표시됩니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-menu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" is-fixed="false" trigger="hover" show-all-menu="true">
...
<sbux-menu id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="jsonData" is-fixed="false" trigger="hover" show-all-menu="true">
   <brand-item text="SoftBowl"></brand-item>
</sbux-menu>
{% endhighlight %}
