...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            호출한 json data에서 style에 해당하는 key값을 지정합니다.<br>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">호출한 json data에서 style에 해당하는 key값</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    var sideJsonData = [
        {"id": "1", "pid":"0",       "order":"1",  "text":"1", "styleKey":"color:red"},
...
<sbux-sidemenu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="sideJsonData" jsondata-style="styleKey"></sbux-sidemenu>
{% endhighlight %}
