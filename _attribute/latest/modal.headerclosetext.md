...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 close button의 문구를 지정합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-modal id="sbIdx1_1" name="sbTagNm1_1" uitype="small" header-close-text="닫기"></sbux-modal>
...
{% highlight html %}
<sbux-modal id="sbIdx1_2" name="sbTagNm1_2" uitype="middle" header-close-text="닫기"></sbux-modal>
...
{% highlight html %}
<sbux-modal id="sbIdx1_3" name="sbTagNm1_3" uitype="large" header-close-text="닫기"></sbux-modal>
