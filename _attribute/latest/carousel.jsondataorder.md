...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">호출한 json data에 order에 해당하는 key값</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    var carouselJsonData=[
        {imagesrc:'./../img/image1.jpg', orderKey:'3'},
        {imagesrc:'./../img/image2.jpg', orderKey:'1'},
        {imagesrc:'./../img/image3.jpg', orderKey:'2'}
    ];
</script>
...
<sbux-carousel id="sbIdx1_1" name="sbTagNm1_1" uitype="image" jsondata-ref="carouselJsonData" jsondata-order="orderKey"></sbux-carousel>
{% endhighlight %}
