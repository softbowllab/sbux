...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">tab의 위치를 지정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">top | bottom | left | right (bottom의 경우 tab-content가 위에 있어야함)</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<sbux-tabs id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" title-target-id-array="tab1_1_1^tab1_1_2" title-text-array="tab1^tab2" is-scrollable="false" placement="bottom"></sbux-tabs>
{% endhighlight %}
...
<sbux-tabs id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="tabJsonData2" is-scrollable="false" placement="bottom"></sbux-tabs>
{% endhighlight %}
...
<sbux-tabs id="sbIdx1_3" name="sbTagNm1_3" uitype="inbox" title-target-id-array="tab1_3_1^tab1_3_2" title-text-array="tab1^tab2" is-scrollable="false" placement="bottom"></sbux-tabs>
{% endhighlight %}
...
<sbux-tabs id="sbIdx1_4" name="sbTagNm1_4" uitype="inbox" jsondata-ref="tabJsonData4" is-scrollable="false" placement="bottom"></sbux-tabs>
{% endhighlight %}
...
<sbux-tabs id="sbIdx1_5" name="sbTagNm1_5" uitype="webacc" title-target-id-array="tab1_5_1^tab1_5_2" title-text-array="tab1^tab2" is-scrollable="false" placement="bottom"></sbux-tabs>
{% endhighlight %}
...
<sbux-tabs id="sbIdx1_6" name="sbTagNm1_6" uitype="webacc" jsondata-ref="tabJsonData6" is-scrollable="false"  placement="bottom"></sbux-tabs>
{% endhighlight %}
