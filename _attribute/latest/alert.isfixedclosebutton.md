---
title:  is-fixed-close-button
date:   2018-05-14
categories: ["latest","alert"]
order: 8
---

is-fixed-close-button
===
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component가 나타날때 close button을 고정합니다.</td>
    </tr>
    <tr>
...
<sbux-alert id="sbIdx1_1" name="sbTagNm1_1" uitype="alert" switch-name="test_1" case-array="{iValue,,input을 선택하셨습니다.,}^{pValue,,picker를 선택하셨습니다.,}^{rValue,,radio를 선택하셨습니다.,}^{sValue,,select를 선택하셨습니다.,}" is-fixed-close-button="true"></sbux-alert>
{% endhighlight %}
