...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">icon에 대한 확장/축소 이벤트를 적용 합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">click | dblclick</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<sbux-tree id="sbIdx1_1" name="sbIdx1_1" uitype="normal" trigger-icon="dblclick">
    <tree-item text="1">
        <tree-item text="1_1">
...
<sbux-tree id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="treeJsonData" trigger-icon="dblclick"></sbux-tree>
{% endhighlight %}
...
{% highlight html %}
<sbux-tree id="sbIdx1_3" name="sbIdx1_3" uitype="checkbox" trigger-icon="dblclick">
    <tree-item text="1">
        <tree-item text="1_1">
            <tree-item text="1_1_1"></tree-item>
        </tree-item>
...
<sbux-tree id="sbIdx1_4" name="sbTagNm1_4" uitype="checkbox" jsondata-ref="treeJsonData" trigger-icon="dblclick"></sbux-tree>
{% endhighlight %}
