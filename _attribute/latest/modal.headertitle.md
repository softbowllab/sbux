...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 title 문구를 지정합니다.</td>
    </tr>
    <tr>
...
{% highlight html %}
<sbux-modal id="sbIdx1_2" name="sbTagNm1_2" uitype="middle" header-title="Modal Title"></sbux-modal>
...
{% highlight html %}
<sbux-modal id="sbIdx1_3" name="sbTagNm1_3" uitype="large" header-title="Modal Title"></sbux-modal>
