...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            Component에 필수입력 속성을 선택적으로 지정합니다.
        </td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">필수입력 속성을 지정할 index (여러개일경우 ','로 구분)</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<form>
    <sbux-checkbox id="sbIdx4" name="sbTagNm4" uitype="normal" jsondata-ref="SBUxData" required-index="0,2"></sbux-checkbox>
