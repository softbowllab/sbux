...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">Component의 데이터를 grid에 실시간으로 반영합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td class="tdCenter" colspan="4">input, textarea</td>
    </tr>
</table>
...
<sbux-input id="sbIdx" name="name" uitype="text" grid-id="datagrid" grid-jit="true"></sbux-input>
{% endhighlight %}
