...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            호출한 json data에서 image title에 해당하는 key값을 지정합니다.<br>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">호출한 json data에서 imagetitle에 해당하는 key값</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    var sideJsonData = [
        ...
        {"id": "2", "pid":"0",       "order":"2",  "text":"2", "imagesrc":"./../img/SBUxLogo.png", "imagetitleKey":"SBUxLogo"},
...
<sbux-sidemenu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="sideJsonData" jsondata-image-title="imagetitleKey"></sbux-sidemenu>
{% endhighlight %}
...
<script>
    ...
    $(document).ready(function(){
        $('#sbArea2_1').sbSidemenu({
            ...
            jsodnataImageTitle : 'imagetitleKey'
        });
    }); 
</script>
{% endhighlight %}
