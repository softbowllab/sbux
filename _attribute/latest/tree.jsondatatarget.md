...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">
            호출한 json data에서 target에 해당하는 key값을 지정합니다.<br>
...
<script>
    var treeJsonData=[
        { "id":"1",     "pid":"-1",  "order" : "1", "text" : "1", "link" : "https://softbowllab.github.io/sbux/attribute/latest/input.uitype#input", "targetKey" : "_blank" },
...
<sbux-tree id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="treeJsonData" jsondata-target="targetKey"></sbux-tree>
{% endhighlight %}
...
<sbux-tree id="sbIdx1_2" name="sbTagNm1_2" uitype="checkbox" jsondata-ref="treeJsonData" jsondata-target="targetKey"></sbux-tree>
{% endhighlight %}
