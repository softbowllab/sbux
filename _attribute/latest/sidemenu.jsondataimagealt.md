...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">호출한 json data에서 imagealt에 해당하는 key값</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
<script>
    var sideJsonData = [
        ...
        {"id": "2", "pid":"0",       "order":"2",  "text":"2", "imagesrc":"./../img/SBUxLogo.png", "imagealtKey":"SBUxLogo"},
...
<sbux-sidemenu id="sbIdx1_1" name="sbTagNm1_1" uitype="normal" jsondata-ref="sideJsonData" jsondata-image-alt="imagealtKey"></sbux-sidemenu>
{% endhighlight %}
