...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">초기 로딩시 확장되어있을 level을 설정합니다.</td>
    </tr>
    <tr>
...
<table style="width:100%">
    ...
    <tr>
        ...
        <td colspan="3">초기 로딩시 확장할 level</td>
    </tr>
</table>
<table style="width:100%">
    <colgroup>
...
{% highlight html %}
<sbux-tree id="sbIdx1_1" name="sbIdx1_1" uitype="normal" is-expand="true" expand-open-level="1">
    <tree-item text="1">
        <tree-item text="1_1">
...
<sbux-tree id="sbIdx1_2" name="sbTagNm1_2" uitype="normal" jsondata-ref="treeJsonData" is-expand="true" expand-open-level="1"></sbux-tree>
{% endhighlight %}
...
{% highlight html %}
<sbux-tree id="sbIdx1_3" name="sbIdx1_3" uitype="checkbox" is-expand="true" expand-open-level="1">
    <tree-item text="1">
        <tree-item text="1_1">
            <tree-item text="1_1_1"></tree-item>
        </tree-item>
...
<sbux-tree id="sbIdx1_4" name="sbTagNm1_4" uitype="checkbox" jsondata-ref="treeJsonData" is-expand="true" expand-open-level="1"></sbux-tree>
{% endhighlight %}
